...
global dof_loc A_pre M_pre gs1_pre gs2_pre
...
A_pre(:, :, 4) = [ 1/2, 0,  1/6,    0, -2/3,    0;
                  ...
                  -2/3, 0, -2/3,    0,  4/3,    0;
                     0, 0,    0, -4/3,    0,  4/3];
% syms x y
% D1 = diff(nodal_basis(x, y), x); 
% D2 = diff(nodal_basis(x, y), y);
% A_pre(:, :, 1) = int(int(D1.' * D1, y, 0, 1 - x), x, 0, 1);
% A_pre(:, :, 2) = int(int(D1.' * D2, y, 0, 1 - x), x, 0, 1);
% A_pre(:, :, 3) = int(int(D2.' * D1, y, 0, 1 - x), x, 0, 1);
% A_pre(:, :, 4) = int(int(D2.' * D2, y, 0, 1 - x), x, 0, 1);

M_pre = [  1/60, -1/360, -1/360, -1/90,     0,     0;
